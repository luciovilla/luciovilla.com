          ...
          <div className="w-full text-gray-800 md:w-4/5 md:pr-12">
            <div className="md:pr-12">
              <p className="mt-4 leading-relaxed">
                Hola! My name is Lucio and I recently made the switch from the newsroom to product
                and now work as a Senior Software Engineer at The Washington Post.
              </p>
              ...
              <p className="mt-4 leading-relaxed">
                ...
                and development in the Graduate School of Journalism at the University of
                California, Berkeley.
              </p>
